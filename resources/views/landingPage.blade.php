        ...
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4 lg:w-1/2" data-aos="fade-right">
            ...
            {{-- <h2 class="font-medium text-secondary text-lg mb-5 lg:text-2xl">
              Web Developer |<span class="text-dark"> Learner</span>
            </h2> --}}
            <p class="font-medium text-secondary mb-10 leading-relaxed">
              Penyedia layanan pembuatan undangan berbasis Website.
            </p>
            <a
              href=""
        ...
        <div class="flex flex-wrap">
          <div class="w-full px-4 mb-10 lg:w-1/2">
            ...
            <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
              ...
              voluptatem voluptatum recusandae fugiat nam rerum ex quis
              similique? Dolore repellendus voluptatibus nemo sunt quas
              blanditiis voluptate aut sequi, qui cumque?
            </p>
          </div>
          <div class="w-full px-4 lg:w-1/2">
            ...
            <p class="font-medium text-base text-secondary mb-6 lg:text-lg">
              ...
              voluptate iste natus aspernatur enim explicabo vel consequatur
              excepturi veniam optio.
            </p>
        ...
        <div class="w-full px-4">
          <div class="max-w-xl mx-auto text-center mb-16">
            ...
            <p class="font-medium text-md text-secondary md:text-lg">
              ...
              quaerat nam error rem necessitatibus ipsa, reiciendis id
              assumenda, tempora dignissimos, vero cum asperiores ipsam rerum.
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden">
              <img src="img/portofolio/1.png" alt="project 1" width="" />
            </div>
            <h3 class="font-semibold text-xl text-dark mt-5">
              Website Beli Sepatu Online
            </h3>
            <p class="font-medium text-base text-secondary">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id
              suscipit, fuga molestiae rem aspernatur nesciunt enim ducimus
              corrupti doloribus cumque!
            </p>
          </div>
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden">
              <img src="img/portofolio/4.png" alt="project 1" width="" />
            </div>
            <h3 class="font-semibold text-xl text-dark mt-5">Website Adidas</h3>
            <p class="font-medium text-base text-secondary">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id
              suscipit, fuga molestiae rem aspernatur nesciunt enim ducimus
              corrupti doloribus cumque!
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden">
              <img src="img/portofolio/2.png" alt="project 2" width="" />
            </div>
            <h3 class="font-semibold text-xl text-dark mt-5">
              Website Techno Park SMKN4 MALANG
            </h3>
            <p class="font-medium text-base text-secondary">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id
              suscipit, fuga molestiae rem aspernatur nesciunt enim ducimus
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden">
              <img src="img/portofolio/3.png" alt="project 3" width="" />
            </div>
            <h3 class="font-semibold text-xl text-dark mt-5">
              Website Grafika Kafe
            </h3>
            <p class="font-medium text-base text-secondary">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id
              suscipit, fuga molestiae rem aspernatur nesciunt enim ducimus
              ...
              <div class="py-8 px-6">
                <h3>
                  <a
                    ...
                    >Undangan Pernikahan</a
                  >
                </h3>
                <p class="font-medium text-base text-secondary mb-6">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Nostrum sit molestiae cumque.
                </p>
                <a
                  href="#"
      ...
      <div class="container">
        ...
        <div class="w-full pt-10 border-t border-slate-700">
          ...
          <p class="font-medium text-xs text-slate-500 text-center">
            ...
            </a> & <a class="text-red-400" href="https://laravel.com">Laravel9</a>
          </p>
        </div>
      </div>
    </footer>
