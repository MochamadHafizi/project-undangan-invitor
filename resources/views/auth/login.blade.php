...
<head>
  ...
  <title>Invitor | Login Page</title>
        ...
        <form method="post" action="{{ route('login') }}">
          ...
          <div class="w-full lg:w-2/3 lg:mx-auto">
            <div class="w-full px-4 mb-8">
                <h2 class="font-bold text-primary text-4xl text-center mb-5">Selamat Datang</h2>
                <p class="text-lg text-primary text-center">Silahkan login terlebih dahulu!</p>
            ...
            <div class="w-full px-4 text-center mx-auto">
              ...
              <p class="text-primary my-10 text-center">Tidak punya akun?<a href="/register"> Daftar akun</a></p>
            </div>
          </div>
        </form>
    </div>
